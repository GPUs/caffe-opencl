...
function(caffe_pickup_caffe_sources root)
  ...
  caffe_source_group("Include"        GLOB "${root}/include/caffe/customcl/*.hpp")
  ...
  caffe_source_group("Source"         GLOB "${root}/src/caffe/customcl*.cpp")
  ...
  if(NOT USE_GLOG)
    list(APPEND srcs
      "${root}/src/ceres/internal/miniglog/glog/logging.cpp")
  endif()
